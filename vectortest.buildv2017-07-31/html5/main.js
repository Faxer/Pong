...
c_collisions.prototype.p_OnUpdate=function(){
	...
	dbg_object(bb_vectortest_square1).m_angle=dbg_object(bb_vectortest_square1).m_angle+1;
...
c_collisions.prototype.p_OnCreate=function(){
	...
	bb_vectortest_square2=c_poly.m_new.call(new c_poly,250,250,4);
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<90>";
	bb_vectortest_square2.p_add_point(c_point.m_new.call(new c_point,-25,-25));
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<93>";
	bb_vectortest_square2.p_add_point(c_point.m_new.call(new c_point,25,-25));
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<96>";
	bb_vectortest_square2.p_add_point(c_point.m_new.call(new c_point,25,25));
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<98>";
	bb_vectortest_square2.p_add_point(c_point.m_new.call(new c_point,-25,25));
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<104>";
	pop_err();
	return 0;
}
...
function bbMain(){
	push_err();
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<110>";
	c_collisions.m_new.call(new c_collisions);
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<111>";
	pop_err();
	return 0;
}
...
c_poly.prototype.p_next_point=function(t_a){
	...
	if(t_a<this.m_num_points-1){
		err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<265>";
		var t_=t_a+1;
		pop_err();
		return t_;
	}else{
		err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<267>";
		pop_err();
		return 0;
	}
}
c_poly.prototype.p_prev_point=function(t_a){
	...
	if(t_a>0){
		err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<273>";
		var t_=t_a-1;
		pop_err();
		return t_;
	}else{
		err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<275>";
...
c_poly.prototype.p_collide=function(t_shape2){
	...
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<294>";
	if((object_downcast((t_shape2),c_circle))!=null){
		...
		err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<298>";
		for(var t_iter=0;t_iter<=this.m_num_points-1;t_iter=t_iter+1){
			err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<299>";
			if(bb_vectortest_distance(((dbg_object(t_circ).m_posx)|0),((dbg_object(t_circ).m_posy)|0),((dbg_object(dbg_array(this.m_points,t_iter)[dbg_index]).m_rotatedx)|0),((dbg_object(dbg_array(this.m_points,t_iter)[dbg_index]).m_rotatedy)|0))<(dbg_object(t_circ).m_width)){
				err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<300>";
				t_hit_this=true;
			}
		}
	}
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<306>";
	if((object_downcast((t_shape2),c_poly))!=null){
		...
		err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<310>";
		for(var t_iter2=0;t_iter2<=this.m_num_points-1;t_iter2=t_iter2+1){
			err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<313>";
			if(dbg_array(dbg_object(this).m_points,t_iter2)[dbg_index].p_collide(t_shape2)==true){
				err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<314>";
				t_hit_this=true;
	...
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<321>";
	pop_err();
	return t_hit_this;
}
c_poly.prototype.p_render=function(){
	...
	for(var t_iter=0;t_iter<=this.m_num_points-1;t_iter=t_iter+1){
		err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<250>";
		...
		err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<251>";
		...
		err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<252>";
		if(dbg_array(this.m_success,t_iter)[dbg_index]==true){
			err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<253>";
	...
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<259>";
...
c_poly.m_new=function(t_x,t_y,t_ps){
	...
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<281>";
	dbg_object(this).m_posx=(t_x);
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<282>";
	dbg_object(this).m_posy=(t_y);
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<283>";
	dbg_object(this).m_angle=0;
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<284>";
...
c_poly.m_new2=function(){
	push_err();
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<236>";
	c_shape.m_new.call(this);
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<236>";
	pop_err();
	return this;
...
c_poly.prototype.p_add_point=function(t_p){
	push_err();
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<243>";
	dbg_array(this.m_points,this.m_point_index)[dbg_index]=t_p;
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<244>";
...
c_point.prototype.p_collide=function(t_shape2){
	push_err();
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<143>";
	var t_result=false;
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<144>";
	var t_other_number=0;
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<145>";
	if((object_downcast((t_shape2),c_poly))!=null){
		err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<146>";
		var t_p=object_downcast((t_shape2),c_poly);
		err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<147>";
		...
		for(var t_iter=0;t_iter<=dbg_object(t_p).m_num_points-1;t_iter=t_iter+1){
			...
			err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<157>";
			...
			err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<163>";
			...
			err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<165>";
			...
			err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<171>";
			dbg_array(t_angle_to_middle,t_iter)[dbg_index]=((t_t333.p_Direction())|0);
			err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<172>";
		...
		err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<180>";
		t_result=true;
		...
		for(var t_iter3=0;t_iter3<=dbg_object(t_p).m_num_points-1;t_iter3=t_iter3+1){
			err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<183>";
			...
			err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<184>";
			...
			err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<186>";
		...
		err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<194>";
		for(var t_iter4=0;t_iter4<=dbg_object(t_p).m_num_points-1;t_iter4=t_iter4+1){
			err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<195>";
			if(dbg_array(dbg_object(t_p).m_success,t_iter4)[dbg_index]==false){
				err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<196>";
				t_result=false;
			}
		}
	}
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<203>";
	pop_err();
	return t_result;
}
c_point.prototype.p_rotate_around=function(t_angle,t_cx,t_cy){
	...
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<126>";
	var t_c=Math.cos((t_angle)*D2R);
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<128>";
	var t_px=dbg_object(this).m_posx;
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<129>";
	...
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<132>";
	...
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<135>";
	dbg_object(this).m_rotatedy=t_ynew+t_cy;
	pop_err();
}
c_point.m_new=function(t_x1,t_y1){
	push_err();
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<118>";
	c_shape.m_new.call(this);
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<119>";
	dbg_object(this).m_posx=(t_x1);
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<120>";
...
c_point.m_new2=function(){
	push_err();
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<114>";
	c_shape.m_new.call(this);
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<114>";
	pop_err();
	return this;
...
c_point.prototype.p_render=function(){
	...
	if(this.m_collided==true){
		err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<209>";
		bb_graphics_SetColor(255.0,255.0,0.0);
	}
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<211>";
	bb_graphics_DrawText(String(this.m_posx)+" "+String(this.m_posy),this.m_posx,this.m_posy,0.0,0.0);
	err_info="/Users/peterscheutz/GitHub/Felix/Pong/vectortest.cxs<212>";
