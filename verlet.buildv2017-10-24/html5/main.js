...
c_myApp.m_new=function(){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<27>";
...
c_myApp.prototype.p_OnCreate=function(){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<31>";
	bb_app_SetUpdateRate(60);
	err_info="C:/GitHub/Pong/verlet.cxs<34>";
	bb_verlet_World=c_Physics.m_new.call(new c_Physics,0.0,0.5,10);
	err_info="C:/GitHub/Pong/verlet.cxs<37>";
	var t_testBody=null;
	err_info="C:/GitHub/Pong/verlet.cxs<38>";
	var t_X=0;
	err_info="C:/GitHub/Pong/verlet.cxs<39>";
	var t_Y=0;
	err_info="C:/GitHub/Pong/verlet.cxs<40>";
	for(t_X=20;t_X<=bb_app_DeviceWidth()-150;t_X=t_X+100){
		err_info="C:/GitHub/Pong/verlet.cxs<41>";
		for(t_Y=50;t_Y<=bb_app_DeviceHeight()-250;t_Y=t_Y+100){
			err_info="C:/GitHub/Pong/verlet.cxs<42>";
			t_testBody=c_PhysicsBody.m_new.call(new c_PhysicsBody);
			err_info="C:/GitHub/Pong/verlet.cxs<43>";
			t_testBody.p_CreateBox(t_X,t_Y,50,50);
		}
	}
	err_info="C:/GitHub/Pong/verlet.cxs<49>";
	for(t_X=50;t_X<=bb_app_DeviceWidth()-50;t_X=t_X+130){
		err_info="C:/GitHub/Pong/verlet.cxs<50>";
		t_testBody=c_PhysicsBody.m_new.call(new c_PhysicsBody);
		err_info="C:/GitHub/Pong/verlet.cxs<51>";
		var t_V1=c_Vertex.m_new.call(new c_Vertex,t_testBody,(t_X),45.0);
		err_info="C:/GitHub/Pong/verlet.cxs<52>";
		var t_V2=c_Vertex.m_new.call(new c_Vertex,t_testBody,(t_X+50),0.0);
		err_info="C:/GitHub/Pong/verlet.cxs<53>";
		var t_V3=c_Vertex.m_new.call(new c_Vertex,t_testBody,(t_X+100),45.0);
		err_info="C:/GitHub/Pong/verlet.cxs<54>";
		c_Edge.m_new.call(new c_Edge,t_testBody,t_V1,t_V2,true);
		err_info="C:/GitHub/Pong/verlet.cxs<55>";
		c_Edge.m_new.call(new c_Edge,t_testBody,t_V2,t_V3,true);
		err_info="C:/GitHub/Pong/verlet.cxs<56>";
...
c_myApp.prototype.p_OnUpdate=function(){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<64>";
	if((bb_input_KeyDown(38))!=0){
		err_info="C:/GitHub/Pong/verlet.cxs<66>";
...
c_myApp.prototype.p_OnRender=function(){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<74>";
	bb_graphics_Cls(0.0,0.0,0.0);
	err_info="C:/GitHub/Pong/verlet.cxs<76>";
...
function bbMain(){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<21>";
...
function bb_graphics_SetGraphicsDevice(t_dev){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<63>";
...
c_Font.m_new=function(t_pages,t_pageCount,t_chars,t_firstChar,t_height){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<100>";
	...
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<102>";
	dbg_object(this).m__firstChar=t_firstChar;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<103>";
...
c_Font.m_Load=function(t_path,t_firstChar,t_numChars,t_padded){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<127>";
	var t_image=bb_graphics_LoadImage(t_path,1,c_Image.m_DefaultFlags);
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<128>";
	var t__pages=new_object_array(1);
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<129>";
	dbg_array(t__pages,0)[dbg_index]=t_image;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<130>";
	...
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<136>";
...
c_Font.m_Load2=function(t_path,t_cellWidth,t_cellHeight,t_glyphX,t_glyphY,t_glyphWidth,t_glyphHeight,t_firstChar,t_numChars){
	...
	var t__charMap=c_IntMap.m_new.call(new c_IntMap);
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<159>";
	var t__pageCount=1;
	...
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<162>";
	var t_w=((t_image.p_Width()/t_cellWidth)|0);
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<163>";
	var t_h=((t_image.p_Height()/t_cellHeight)|0);
	...
	for(var t_i=0;t_i<t_numChars;t_i=t_i+1){
		...
		var t_x=t_i % t_w;
		err_info="C:/Cerberus/modules/mojo/graphics.cxs<168>";
		var t_glyph=c_Glyph.m_new.call(new c_Glyph,0,t_firstChar+t_i,t_x*t_cellWidth+t_glyphX,t_y*t_cellHeight+t_glyphY,t_glyphWidth,t_glyphHeight,t_glyphWidth);
...
c_Font.m_Load3=function(t_url){
	...
	var t_idnum=0;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<180>";
	var t_tmpChar=null;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<181>";
	var t_plLen=0;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<182>";
	var t_lines=[];
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<184>";
	var t_filename="";
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<185>";
	var t_lineHeight=0;
	...
	var t_path="";
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<193>";
	if(t_url.indexOf("/",0)>-1){
		...
		t_plLen=t_pl.length;
		err_info="C:/Cerberus/modules/mojo/graphics.cxs<196>";
	...
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<200>";
	var t_ts=t_url.toLowerCase();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<201>";
	if(t_ts.indexOf(".txt",0)>0){
		err_info="C:/Cerberus/modules/mojo/graphics.cxs<202>";
	...
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<208>";
	if(t_lines.length<2){
		err_info="C:/Cerberus/modules/mojo/graphics.cxs<209>";
	...
	while(t_2<t_.length){
		...
		err_info="C:/Cerberus/modules/mojo/graphics.cxs<215>";
		if(string_startswith(t_line,"info") || t_line==""){
			err_info="C:/Cerberus/modules/mojo/graphics.cxs<215>";
			continue;
		}
		err_info="C:/Cerberus/modules/mojo/graphics.cxs<216>";
		...
		if(string_startswith(t_line,"common")){
			...
			while(t_4<t_3.length){
				...
				if(string_startswith(t_common,"pages=")){
					...
					err_info="C:/Cerberus/modules/mojo/graphics.cxs<230>";
		...
		if(string_startswith(t_line,"page")){
			...
			while(t_6<t_5.length){
				...
				if(string_startswith(t_data,"file=")){
					...
					err_info="C:/Cerberus/modules/mojo/graphics.cxs<242>";
					dbg_array(t_fn,1)[dbg_index]=string_trim(dbg_array(t_fn,1)[dbg_index]);
					err_info="C:/Cerberus/modules/mojo/graphics.cxs<243>";
					t_filename=dbg_array(t_fn,1)[dbg_index];
					err_info="C:/Cerberus/modules/mojo/graphics.cxs<244>";
					if(dbg_charCodeAt(t_filename,0)==34){
						err_info="C:/Cerberus/modules/mojo/graphics.cxs<245>";
		...
		err_info="C:/Cerberus/modules/mojo/graphics.cxs<258>";
		if(string_startswith(t_line,"chars")){
			err_info="C:/Cerberus/modules/mojo/graphics.cxs<258>";
			continue;
		}
		err_info="C:/Cerberus/modules/mojo/graphics.cxs<260>";
		if(string_startswith(t_line,"char")){
			...
			err_info="C:/Cerberus/modules/mojo/graphics.cxs<262>";
			...
			while(t_8<t_7.length){
				...
				err_info="C:/Cerberus/modules/mojo/graphics.cxs<263>";
				t_8=t_8+1;
				err_info="C:/Cerberus/modules/mojo/graphics.cxs<264>";
				if(string_startswith(t_data2,"id=")){
					err_info="C:/Cerberus/modules/mojo/graphics.cxs<265>";
					var t_idc=t_data2.split("=");
					err_info="C:/Cerberus/modules/mojo/graphics.cxs<266>";
					dbg_array(t_idc,1)[dbg_index]=string_trim(dbg_array(t_idc,1)[dbg_index]);
					err_info="C:/Cerberus/modules/mojo/graphics.cxs<267>";
					dbg_object(t_tmpChar).m_id=parseInt((dbg_array(t_idc,1)[dbg_index]),10);
				}
				err_info="C:/Cerberus/modules/mojo/graphics.cxs<269>";
...
c_GraphicsContext.m_new=function(){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<29>";
	pop_err();
	return this;
}
c_GraphicsContext.prototype.p_Validate=function(){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<40>";
	if((this.m_matDirty)!=0){
		err_info="C:/Cerberus/modules/mojo/graphics.cxs<41>";
		...
		err_info="C:/Cerberus/modules/mojo/graphics.cxs<42>";
		this.m_matDirty=0;
	}
	pop_err();
	return 0;
...
c_Image.m_new=function(){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<326>";
	pop_err();
	return this;
}
c_Image.prototype.p_SetHandle=function(t_tx,t_ty){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<370>";
	dbg_object(this).m_tx=t_tx;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<371>";
	dbg_object(this).m_ty=t_ty;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<372>";
...
c_Image.prototype.p_ApplyFlags=function(t_iflags){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<454>";
	this.m_flags=t_iflags;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<456>";
	if((this.m_flags&2)!=0){
		err_info="C:/Cerberus/modules/mojo/graphics.cxs<457>";
		err_info="C:/Cerberus/modules/mojo/graphics.cxs<457>";
		...
		while(t_2<t_.length){
			...
			err_info="C:/Cerberus/modules/mojo/graphics.cxs<457>";
			t_2=t_2+1;
			err_info="C:/Cerberus/modules/mojo/graphics.cxs<458>";
			dbg_object(t_f).m_x+=1;
		}
		err_info="C:/Cerberus/modules/mojo/graphics.cxs<460>";
		this.m_width-=2;
	}
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<463>";
	if((this.m_flags&4)!=0){
		...
		while(t_4<t_3.length){
			...
			err_info="C:/Cerberus/modules/mojo/graphics.cxs<464>";
			t_4=t_4+1;
			err_info="C:/Cerberus/modules/mojo/graphics.cxs<465>";
	...
	if((this.m_flags&1)!=0){
		err_info="C:/Cerberus/modules/mojo/graphics.cxs<471>";
...
c_Image.prototype.p_Init=function(t_surf,t_nframes,t_iflags){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<400>";
	if((this.m_surface)!=null){
		err_info="C:/Cerberus/modules/mojo/graphics.cxs<400>";
		error("Image already initialized");
	}
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<401>";
	this.m_surface=t_surf;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<403>";
	this.m_width=((this.m_surface.Width()/t_nframes)|0);
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<404>";
	this.m_height=this.m_surface.Height();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<406>";
	this.m_frames=new_object_array(t_nframes);
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<407>";
	for(var t_i=0;t_i<t_nframes;t_i=t_i+1){
		err_info="C:/Cerberus/modules/mojo/graphics.cxs<408>";
	...
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<412>";
	pop_err();
	return this;
}
c_Image.prototype.p_Init2=function(t_surf,t_x,t_y,t_iwidth,t_iheight,t_nframes,t_iflags,t_src,t_srcx,t_srcy,t_srcw,t_srch){
	...
	this.m_source=t_src;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<420>";
	this.m_width=t_iwidth;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<421>";
	this.m_height=t_iheight;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<423>";
	this.m_frames=new_object_array(t_nframes);
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<425>";
	var t_ix=t_x;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<425>";
	var t_iy=t_y;
	...
	for(var t_i=0;t_i<t_nframes;t_i=t_i+1){
		...
		if(t_ix+this.m_width>t_srcw){
			err_info="C:/Cerberus/modules/mojo/graphics.cxs<429>";
			t_ix=0;
			err_info="C:/Cerberus/modules/mojo/graphics.cxs<430>";
			t_iy+=this.m_height;
		}
		err_info="C:/Cerberus/modules/mojo/graphics.cxs<432>";
		...
		err_info="C:/Cerberus/modules/mojo/graphics.cxs<436>";
		t_ix+=this.m_width;
	}
...
c_Image.prototype.p_Width=function(){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<337>";
	pop_err();
	return this.m_width;
}
c_Image.prototype.p_Height=function(){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<341>";
	pop_err();
...
c_Frame.m_new=function(t_x,t_y){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<23>";
	dbg_object(this).m_x=t_x;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<24>";
...
c_Frame.m_new2=function(){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<18>";
	pop_err();
	return this;
}
...
function bb_graphics_LoadImage2(t_path,t_frameWidth,t_frameHeight,t_frameCount,t_flags){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<501>";
	var t_surf=bb_graphics_device.LoadSurface(bb_data_FixDataPath(t_path));
...
c_Glyph.m_new=function(t_page,t_id,t_x,t_y,t_width,t_height,t_advance){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<85>";
	dbg_object(this).m_page=t_page;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<86>";
	dbg_object(this).m_id=t_id;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<87>";
	dbg_object(this).m_x=t_x;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<88>";
	dbg_object(this).m_y=t_y;
...
c_Glyph.m_new2=function(){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<72>";
	pop_err();
	return this;
}
function c_Map(){
...
function bb_graphics_SetFont(t_font){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<868>";
	if(!((t_font)!=null)){
		err_info="C:/Cerberus/modules/mojo/graphics.cxs<869>";
		if(!((dbg_object(bb_graphics_context).m_defaultFont)!=null)){
			err_info="C:/Cerberus/modules/mojo/graphics.cxs<870>";
			dbg_object(bb_graphics_context).m_defaultFont=c_Font.m_Load("mojo_font.png",32,96,false);
		}
		err_info="C:/Cerberus/modules/mojo/graphics.cxs<872>";
		t_font=dbg_object(bb_graphics_context).m_defaultFont;
	}
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<874>";
...
c_InputDevice.prototype.p_PutKeyHit=function(t_key){
	push_err();
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<249>";
	if(this.m__keyHitPut==this.m__keyHitQueue.length){
		pop_err();
		return;
	}
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<250>";
	dbg_array(this.m__keyHit,t_key)[dbg_index]+=1;
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<251>";
	dbg_array(this.m__keyHitQueue,this.m__keyHitPut)[dbg_index]=t_key;
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<252>";
	this.m__keyHitPut+=1;
	pop_err();
}
c_InputDevice.prototype.p_BeginUpdate=function(){
	push_err();
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<200>";
	for(var t_i=0;t_i<4;t_i=t_i+1){
		err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<201>";
		...
		for(var t_j=0;t_j<32;t_j=t_j+1){
			err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<204>";
			var t_key=256+t_i*32+t_j;
			err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<205>";
			if(dbg_array(dbg_object(t_state).m_buttons,t_j)[dbg_index]){
				err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<206>";
				...
				err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<211>";
...
c_InputDevice.prototype.p_EndUpdate=function(){
	...
	this.m__keyHitPut=0;
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<222>";
	this.m__charGet=0;
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<223>";
	this.m__charPut=0;
	pop_err();
}
c_InputDevice.prototype.p_KeyEvent=function(t_event,t_data){
	push_err();
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<121>";
	var t_1=t_event;
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<122>";
	if(t_1==1){
		err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<123>";
		if(!dbg_array(this.m__keyDown,t_data)[dbg_index]){
			err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<124>";
			dbg_array(this.m__keyDown,t_data)[dbg_index]=true;
			err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<125>";
			this.p_PutKeyHit(t_data);
			err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<126>";
			if(t_data==1){
				err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<127>";
				dbg_array(this.m__keyDown,384)[dbg_index]=true;
				err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<128>";
				this.p_PutKeyHit(384);
			}else{
				err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<129>";
				if(t_data==384){
					err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<130>";
					dbg_array(this.m__keyDown,1)[dbg_index]=true;
					err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<131>";
					this.p_PutKeyHit(1);
				}
			}
		}
		...
		if(t_1==2){
			...
			if(t_1==3){
				...
				if(this.m__charPut<this.m__charQueue.length){
					err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<145>";
					dbg_array(this.m__charQueue,this.m__charPut)[dbg_index]=t_data;
					err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<146>";
					this.m__charPut+=1;
				}
			}
		}
...
c_InputDevice.prototype.p_MouseEvent=function(t_event,t_data,t_x,t_y,t_z){
	...
	if(t_2==4){
		err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<154>";
		this.p_KeyEvent(1,1+t_data);
	}else{
		err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<155>";
		if(t_2==5){
	...
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<162>";
	this.m__mouseX=t_x;
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<163>";
	this.m__mouseY=t_y;
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<164>";
	this.m__mouseZ=t_z;
...
c_InputDevice.prototype.p_TouchEvent=function(t_event,t_data,t_x,t_y){
	push_err();
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<170>";
	var t_3=t_event;
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<171>";
	if(t_3==7){
		err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<172>";
		this.p_KeyEvent(1,384+t_data);
	}else{
		err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<173>";
		if(t_3==8){
			err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<174>";
	...
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<180>";
	dbg_array(this.m__touchX,t_data)[dbg_index]=t_x;
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<181>";
	dbg_array(this.m__touchY,t_data)[dbg_index]=t_y;
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<182>";
	if(t_data==0){
...
c_InputDevice.prototype.p_MotionEvent=function(t_event,t_data,t_x,t_y,t_z){
	...
	var t_4=t_event;
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<190>";
	if(t_4==10){
	}else{
		pop_err();
		return;
...
c_InputDevice.prototype.p_KeyDown=function(t_key){
	push_err();
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<47>";
	if(t_key>0 && t_key<512){
		err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<47>";
		pop_err();
		return dbg_array(this.m__keyDown,t_key)[dbg_index];
	}
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<48>";
	pop_err();
	return false;
}
function c_JoyState(){
...
function bb_graphics_SetMatrix(t_ix,t_iy,t_jx,t_jy,t_tx,t_ty){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<569>";
	dbg_object(bb_graphics_context).m_ix=t_ix;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<570>";
	dbg_object(bb_graphics_context).m_iy=t_iy;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<571>";
	dbg_object(bb_graphics_context).m_jx=t_jx;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<572>";
	dbg_object(bb_graphics_context).m_jy=t_jy;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<573>";
	...
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<576>";
...
function bb_graphics_SetColor(t_r,t_g,t_b){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<511>";
	dbg_object(bb_graphics_context).m_color_r=t_r;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<512>";
	dbg_object(bb_graphics_context).m_color_g=t_g;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<513>";
	dbg_object(bb_graphics_context).m_color_b=t_b;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<514>";
...
function bb_graphics_SetAlpha(t_alpha){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<528>";
...
function bb_graphics_SetBlend(t_blend){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<537>";
...
function bb_graphics_SetScissor(t_x,t_y,t_width,t_height){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<546>";
...
function bb_graphics_BeginRender(){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<482>";
	bb_graphics_renderDevice=bb_graphics_device;
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<483>";
	...
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<486>";
	bb_graphics_SetAlpha(1.0);
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<487>";
	bb_graphics_SetBlend(0);
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<488>";
...
function bb_app_SetUpdateRate(t_hertz){
	push_err();
	err_info="C:/Cerberus/modules/mojo/app.cxs<224>";
	bb_app__updateRate=t_hertz;
	err_info="C:/Cerberus/modules/mojo/app.cxs<225>";
...
c_Physics.m_new=function(t_GravitationX,t_GravitationY,t_pIterations){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<569>";
	this.m_BodyCount=0;
	err_info="C:/GitHub/Pong/verlet.cxs<570>";
	this.m_VertexCount=0;
	err_info="C:/GitHub/Pong/verlet.cxs<571>";
	this.m_EdgeCount=0;
	err_info="C:/GitHub/Pong/verlet.cxs<572>";
	this.m_Timestep=1.0;
	err_info="C:/GitHub/Pong/verlet.cxs<573>";
	this.m_Gravity=c_Vec2.m_new.call(new c_Vec2,t_GravitationX,t_GravitationY);
	err_info="C:/GitHub/Pong/verlet.cxs<574>";
...
c_Physics.prototype.p_UpdateForces=function(){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<197>";
	var t_i=0;
	err_info="C:/GitHub/Pong/verlet.cxs<198>";
	for(t_i=0;t_i<=dbg_object(this).m_VertexCount-1;t_i=t_i+1){
		err_info="C:/GitHub/Pong/verlet.cxs<199>";
...
c_Physics.prototype.p_UpdateVerlet=function(){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<207>";
	var t_i=0;
	err_info="C:/GitHub/Pong/verlet.cxs<208>";
	for(t_i=0;t_i<=this.m_VertexCount-1;t_i=t_i+1){
		err_info="C:/GitHub/Pong/verlet.cxs<210>";
		var t_V=dbg_array(this.m_Vertices,t_i)[dbg_index];
		err_info="C:/GitHub/Pong/verlet.cxs<212>";
		var t_TempX=dbg_object(dbg_object(t_V).m_Position).m_X;
		err_info="C:/GitHub/Pong/verlet.cxs<213>";
		var t_TempY=dbg_object(dbg_object(t_V).m_Position).m_Y;
		err_info="C:/GitHub/Pong/verlet.cxs<215>";
		...
		err_info="C:/GitHub/Pong/verlet.cxs<216>";
		...
		err_info="C:/GitHub/Pong/verlet.cxs<220>";
		dbg_object(dbg_object(t_V).m_OldPosition).m_X=t_TempX;
		err_info="C:/GitHub/Pong/verlet.cxs<221>";
...
c_Physics.prototype.p_UpdateEdges=function(){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<230>";
	var t_i=0;
	err_info="C:/GitHub/Pong/verlet.cxs<231>";
	for(t_i=0;t_i<=this.m_EdgeCount-1;t_i=t_i+1){
		err_info="C:/GitHub/Pong/verlet.cxs<234>";
		var t_E=dbg_array(this.m_Edges,t_i)[dbg_index];
		err_info="C:/GitHub/Pong/verlet.cxs<237>";
		...
		err_info="C:/GitHub/Pong/verlet.cxs<238>";
		t_V1V2.p_SubtractVec(dbg_object(dbg_object(t_E).m_V1).m_Position);
		err_info="C:/GitHub/Pong/verlet.cxs<240>";
		var t_V1V2Length=t_V1V2.p_GetLength();
		err_info="C:/GitHub/Pong/verlet.cxs<241>";
		var t_Diff=t_V1V2Length-dbg_object(t_E).m_Length;
		err_info="C:/GitHub/Pong/verlet.cxs<243>";
		t_V1V2.p_Normalize();
		err_info="C:/GitHub/Pong/verlet.cxs<245>";
		...
		err_info="C:/GitHub/Pong/verlet.cxs<246>";
		...
		err_info="C:/GitHub/Pong/verlet.cxs<247>";
		...
		err_info="C:/GitHub/Pong/verlet.cxs<248>";
...
c_Physics.prototype.p_BodiesOverlap=function(t_B1,t_B2){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<509>";
...
c_Physics.prototype.p_DetectCollision=function(t_B1,t_B2){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<309>";
	var t_MinDistance=10000.0;
	err_info="C:/GitHub/Pong/verlet.cxs<311>";
	var t_i=0;
	err_info="C:/GitHub/Pong/verlet.cxs<312>";
	for(t_i=0;t_i<=dbg_object(t_B1).m_EdgeCount+dbg_object(t_B2).m_EdgeCount-2;t_i=t_i+1){
		err_info="C:/GitHub/Pong/verlet.cxs<315>";
		var t_E=null;
		err_info="C:/GitHub/Pong/verlet.cxs<319>";
		if(t_i<dbg_object(t_B1).m_EdgeCount){
			err_info="C:/GitHub/Pong/verlet.cxs<321>";
			t_E=dbg_array(dbg_object(t_B1).m_Edges,t_i)[dbg_index];
		}else{
			err_info="C:/GitHub/Pong/verlet.cxs<325>";
			t_E=dbg_array(dbg_object(t_B2).m_Edges,t_i-dbg_object(t_B1).m_EdgeCount)[dbg_index];
		}
		err_info="C:/GitHub/Pong/verlet.cxs<334>";
		if(!dbg_object(t_E).m_Boundary){
			err_info="C:/GitHub/Pong/verlet.cxs<336>";
			continue;
		}
		err_info="C:/GitHub/Pong/verlet.cxs<341>";
		...
		err_info="C:/GitHub/Pong/verlet.cxs<342>";
		dbg_object(t_Axis).m_X=dbg_object(t_Axis).m_X-dbg_object(dbg_object(dbg_object(t_E).m_V2).m_Position).m_Y;
		err_info="C:/GitHub/Pong/verlet.cxs<343>";
		dbg_object(t_Axis).m_Y=dbg_object(t_Axis).m_Y-dbg_object(dbg_object(dbg_object(t_E).m_V1).m_Position).m_X;
		err_info="C:/GitHub/Pong/verlet.cxs<345>";
		t_Axis.p_Normalize();
		err_info="C:/GitHub/Pong/verlet.cxs<351>";
		var t_MinA=new_number_array(1);
		err_info="C:/GitHub/Pong/verlet.cxs<352>";
		var t_MinB=new_number_array(1);
		err_info="C:/GitHub/Pong/verlet.cxs<353>";
		var t_MaxA=new_number_array(1);
		err_info="C:/GitHub/Pong/verlet.cxs<354>";
		var t_MaxB=new_number_array(1);
		err_info="C:/GitHub/Pong/verlet.cxs<357>";
		t_B1.p_ProjectToAxis(t_Axis,t_MinA,t_MaxA);
		err_info="C:/GitHub/Pong/verlet.cxs<359>";
		t_B2.p_ProjectToAxis(t_Axis,t_MinB,t_MaxB);
		err_info="C:/GitHub/Pong/verlet.cxs<364>";
		var t_Distance=this.p_IntervalDistance(t_MinA,t_MaxA,t_MinB,t_MaxB);
		err_info="C:/GitHub/Pong/verlet.cxs<369>";
		if(t_Distance>0.0){
			err_info="C:/GitHub/Pong/verlet.cxs<371>";
			pop_err();
			return false;
		}else{
			err_info="C:/GitHub/Pong/verlet.cxs<373>";
			if(bb_math_Abs2(t_Distance)<t_MinDistance){
				err_info="C:/GitHub/Pong/verlet.cxs<375>";
				t_MinDistance=bb_math_Abs2(t_Distance);
				err_info="C:/GitHub/Pong/verlet.cxs<377>";
				c_Physics.m_CollisionInfoNormal=t_Axis;
				err_info="C:/GitHub/Pong/verlet.cxs<379>";
				c_Physics.m_CollisionInfoE=t_E;
			}
		}
	}
	err_info="C:/GitHub/Pong/verlet.cxs<386>";
	c_Physics.m_CollisionInfoDepth=t_MinDistance;
	err_info="C:/GitHub/Pong/verlet.cxs<391>";
	if(dbg_object(c_Physics.m_CollisionInfoE).m_Parent!=t_B2){
		err_info="C:/GitHub/Pong/verlet.cxs<393>";
		var t_Temp=t_B2;
		err_info="C:/GitHub/Pong/verlet.cxs<395>";
		t_B2=t_B1;
		err_info="C:/GitHub/Pong/verlet.cxs<397>";
		t_B1=t_Temp;
	}
	err_info="C:/GitHub/Pong/verlet.cxs<403>";
	...
	err_info="C:/GitHub/Pong/verlet.cxs<404>";
	...
	err_info="C:/GitHub/Pong/verlet.cxs<405>";
	t_CenterDiff.p_SubtractVec(dbg_object(t_B2).m_Center);
	err_info="C:/GitHub/Pong/verlet.cxs<406>";
	...
	err_info="C:/GitHub/Pong/verlet.cxs<425>";
	t_CollisionVector.p_Multiply(c_Physics.m_CollisionInfoDepth,c_Physics.m_CollisionInfoDepth);
	err_info="C:/GitHub/Pong/verlet.cxs<431>";
	var t_SmallestD=10000.0;
	err_info="C:/GitHub/Pong/verlet.cxs<433>";
	var t_Distance2=.0;
	err_info="C:/GitHub/Pong/verlet.cxs<436>";
	for(t_i=0;t_i<=dbg_object(t_B1).m_VertexCount-1;t_i=t_i+1){
		err_info="C:/GitHub/Pong/verlet.cxs<439>";
		...
		err_info="C:/GitHub/Pong/verlet.cxs<440>";
		t_cDist.p_SubtractVec(dbg_object(t_B2).m_Center);
		err_info="C:/GitHub/Pong/verlet.cxs<442>";
...
c_Physics.prototype.p_ProcessCollision=function(){
	...
	err_info="C:/GitHub/Pong/verlet.cxs<474>";
	var t_T=.0;
	err_info="C:/GitHub/Pong/verlet.cxs<476>";
	if(bb_math_Abs2(dbg_object(dbg_object(t_E1).m_Position).m_X-dbg_object(dbg_object(t_E2).m_Position).m_X)>bb_math_Abs2(dbg_object(dbg_object(t_E1).m_Position).m_Y-dbg_object(dbg_object(t_E2).m_Position).m_Y)){
		err_info="C:/GitHub/Pong/verlet.cxs<477>";
		...
		err_info="C:/GitHub/Pong/verlet.cxs<479>";
	...
	err_info="C:/GitHub/Pong/verlet.cxs<481>";
	var t_Lambda=1.0/(t_T*t_T+(1.0-t_T)*(1.0-t_T));
	err_info="C:/GitHub/Pong/verlet.cxs<483>";
	...
	err_info="C:/GitHub/Pong/verlet.cxs<484>";
	...
	err_info="C:/GitHub/Pong/verlet.cxs<486>";
	...
	err_info="C:/GitHub/Pong/verlet.cxs<487>";
	...
	err_info="C:/GitHub/Pong/verlet.cxs<489>";
	...
	err_info="C:/GitHub/Pong/verlet.cxs<490>";
...
c_Physics.prototype.p_Update=function(){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<515>";
	this.p_UpdateForces();
	err_info="C:/GitHub/Pong/verlet.cxs<516>";
	this.p_UpdateVerlet();
	err_info="C:/GitHub/Pong/verlet.cxs<517>";
...
c_Physics.prototype.p_Render=function(){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<524>";
	var t_i=0;
	err_info="C:/GitHub/Pong/verlet.cxs<525>";
	for(t_i=0;t_i<=this.m_EdgeCount-1;t_i=t_i+1){
		err_info="C:/GitHub/Pong/verlet.cxs<526>";
...
c_Vec2.m_new=function(t_vX,t_vY){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<95>";
	dbg_object(this).m_X=t_vX;
	err_info="C:/GitHub/Pong/verlet.cxs<96>";
...
c_Vec2.m_new2=function(){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<90>";
	pop_err();
	return this;
}
c_Vec2.prototype.p_SubtractVec=function(t_Vec){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<116>";
	if(t_Vec==null){
		err_info="C:/GitHub/Pong/verlet.cxs<116>";
		pop_err();
		return 0;
	}
	err_info="C:/GitHub/Pong/verlet.cxs<117>";
	this.m_X=this.m_X-dbg_object(t_Vec).m_X;
	err_info="C:/GitHub/Pong/verlet.cxs<118>";
...
c_Vec2.prototype.p_GetLength=function(){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<144>";
...
c_Vec2.prototype.p_Normalize=function(){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<149>";
	var t_Lent=1.0/this.p_GetLength();
	err_info="C:/GitHub/Pong/verlet.cxs<150>";
	this.m_X=this.m_X*t_Lent;
	err_info="C:/GitHub/Pong/verlet.cxs<151>";
...
c_Vec2.prototype.p_AddVec=function(t_Vec){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<110>";
	if(t_Vec==null){
		err_info="C:/GitHub/Pong/verlet.cxs<110>";
		pop_err();
		return 0;
	}
	err_info="C:/GitHub/Pong/verlet.cxs<111>";
	this.m_X=this.m_X+dbg_object(t_Vec).m_X;
	err_info="C:/GitHub/Pong/verlet.cxs<112>";
	this.m_Y=this.m_Y+dbg_object(t_Vec).m_Y;
	pop_err();
	return 0;
}
c_Vec2.prototype.p_Divide=function(t__x,t__y){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<133>";
	if(t__x==0.0 || t__y==0.0){
		err_info="C:/GitHub/Pong/verlet.cxs<133>";
		pop_err();
		return 0;
	}
	err_info="C:/GitHub/Pong/verlet.cxs<134>";
	this.m_X=this.m_X/t__x;
	err_info="C:/GitHub/Pong/verlet.cxs<135>";
...
c_Vec2.prototype.p_DotProduct=function(t_Vec){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<140>";
...
c_Vec2.prototype.p_Multiply=function(t__x,t__y){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<122>";
	this.m_X=this.m_X*t__x;
	err_info="C:/GitHub/Pong/verlet.cxs<123>";
	this.m_Y=this.m_Y*t__y;
	pop_err();
	return 0;
}
...
c_PhysicsBody.m_new=function(){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<621>";
	dbg_object(this).m_VertexCount=0;
	err_info="C:/GitHub/Pong/verlet.cxs<622>";
	dbg_object(this).m_EdgeCount=0;
	err_info="C:/GitHub/Pong/verlet.cxs<623>";
...
c_Vertex.m_new2=function(){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<707>";
	pop_err();
	return this;
}
...
c_Edge.m_new=function(t_Body,t_pV1,t_pV2,t_pBoundary){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<765>";
	dbg_object(this).m_V1=t_pV1;
	err_info="C:/GitHub/Pong/verlet.cxs<767>";
	dbg_object(this).m_V2=t_pV2;
	err_info="C:/GitHub/Pong/verlet.cxs<771>";
	...
	err_info="C:/GitHub/Pong/verlet.cxs<772>";
	t_this.p_SubtractVec(dbg_object(t_pV1).m_Position);
	err_info="C:/GitHub/Pong/verlet.cxs<773>";
	dbg_object(this).m_Length=t_this.p_GetLength();
	err_info="C:/GitHub/Pong/verlet.cxs<777>";
	dbg_object(this).m_Boundary=t_pBoundary;
	err_info="C:/GitHub/Pong/verlet.cxs<781>";
	dbg_object(this).m_Parent=t_Body;
	err_info="C:/GitHub/Pong/verlet.cxs<786>";
	t_Body.p_AddEdge(this);
	err_info="C:/GitHub/Pong/verlet.cxs<788>";
...
c_Edge.m_new2=function(){
	push_err();
	err_info="C:/GitHub/Pong/verlet.cxs<741>";
	pop_err();
	return this;
}
...
function bb_input_KeyDown(t_key){
	push_err();
	err_info="C:/Cerberus/modules/mojo/input.cxs<40>";
...
function bb_math_Abs(t_x){
	push_err();
	err_info="C:/Cerberus/modules/cerberus/math.cxs<46>";
	if(t_x>=0){
		err_info="C:/Cerberus/modules/cerberus/math.cxs<46>";
		pop_err();
		return t_x;
	}
	err_info="C:/Cerberus/modules/cerberus/math.cxs<47>";
	var t_=-t_x;
	pop_err();
	return t_;
}
function bb_math_Abs2(t_x){
	push_err();
	err_info="C:/Cerberus/modules/cerberus/math.cxs<73>";
	if(t_x>=0.0){
		err_info="C:/Cerberus/modules/cerberus/math.cxs<73>";
		pop_err();
		return t_x;
	}
	err_info="C:/Cerberus/modules/cerberus/math.cxs<74>";
	var t_=-t_x;
	pop_err();
	return t_;
}
function bb_math_Sgn(t_x){
	push_err();
	err_info="C:/Cerberus/modules/cerberus/math.cxs<41>";
	if(t_x<0){
		err_info="C:/Cerberus/modules/cerberus/math.cxs<41>";
		pop_err();
		return -1;
	}
	err_info="C:/Cerberus/modules/cerberus/math.cxs<42>";
	var t_=((t_x>0)?1:0);
	pop_err();
	return t_;
}
function bb_math_Sgn2(t_x){
	push_err();
	err_info="C:/Cerberus/modules/cerberus/math.cxs<67>";
	if(t_x<0.0){
		err_info="C:/Cerberus/modules/cerberus/math.cxs<67>";
		pop_err();
		return -1.0;
	}
	err_info="C:/Cerberus/modules/cerberus/math.cxs<68>";
	if(t_x>0.0){
		err_info="C:/Cerberus/modules/cerberus/math.cxs<68>";
		pop_err();
		return 1.0;
	}
	err_info="C:/Cerberus/modules/cerberus/math.cxs<69>";
	pop_err();
	return 0.0;
}
function bb_graphics_DebugRenderDevice(){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<53>";
...
function bb_graphics_Cls(t_r,t_g,t_b){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<635>";
	bb_graphics_DebugRenderDevice();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<637>";
...
function bb_graphics_DrawLine(t_x1,t_y1,t_x2,t_y2){
	push_err();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<658>";
	bb_graphics_DebugRenderDevice();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<660>";
	bb_graphics_context.p_Validate();
	err_info="C:/Cerberus/modules/mojo/graphics.cxs<661>";
